...
export const CardThematic = ({ _id, name, description, isCreator, goToSee, goToCreate }: ThematicCard) => {
    const handlerSeeContent = () => goToSee(_id);
    const handlerCreateContent = () => goToCreate(_id);
    return (
        <div
            className="relative flex flex-col m-3 text-gray-50 bg-gray-800 shadow-md bg-clip-border rounded-xl w-60">
            <div className="p-6">
                <h5
            ...
            <div onClick={handlerSeeContent}
                ...
                <span className="inline-block bg-gray-100 rounded-full px-3 py-1 text-sm font-semibold text-gray-950 mr-2 mb-2 cursor-pointer">
                    Ver Contenido
                </span>
            </div>
            {isCreator ?
